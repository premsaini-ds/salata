...
const openClose = {
  formatOpenNowString: (hoursData: any, utcOffset: any) => {
    ...
    if (openRightNow) {
      ...
      } else if (currentInterval?.end == "24:00") {
      } else {
        hoursString = "Closed - Open at [openingTime]";
        hoursString = hoursString.replace(
          "[openingTime]",
...
export default function Hours2(props: any) {
  let parsedOffset = openClose.parseTimeZoneUtcOffset(
